  ...
  return show ? (
    <div className="flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50">
      ...
      <div className="relative flex flex-1 flex-col items-center max-md:mt-16 ">
        ...
        <button onClick={bookTickets} className="flex items-center gap-1 mt-20 bg-primary px-10 py-3 text-sm font-medium rounded-full hover:bg-primary-dull transition active:scale-95 cursor-pointer">
          Proceed to checkout
